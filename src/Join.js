...
const Advantage = (props) => {
    return (
        <div className="join-container">
            ...
            <p className="normal-text normal-color tel tei">
            ...
            <p className="title">舒服消费空间</p>
            <p className="normal-text normal-color tel tei">公司拥有专一讲师4名，均有3年以上的培训和带队经历，具有相当的理论水平和实战经验，经由他们培训，确保店员对门店运营得心应手</p>
        </div>
        // <div className="p">
...
const Aptitude = (props) => {
    return (
        <div className="join-container">
            <p className="normal-text normal-color tei">
...
const Support = (props) => {
    return (
        <div className="join-container">
               <p className="normal-text normal-color clear tel tei" style={{ border: 1 }}>
               一、总部协助评估商业圈所在地，借由长期展店经验分析，将商业圈优势发挥完美。
               </p>

               <p className="normal-text normal-color clear tel tei">
