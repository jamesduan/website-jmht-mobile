    ...
    return (
        <div className="sub-container">
            ...
            <div className="images">
                <div className="box">
                    <img alt="" src={p01} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">桃香乌龙霜降</div>
                </div>
                <div className="box">
                    <img alt="" src={p02} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">四季春霜降</div>
                </div>
                <div className="box">
                    <img alt="" src={p05} style={{ width: "100%", height: "100%" }} />
            ...
            <div className="images">
                <div className="box">
                    <img alt="" src={p09} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">桃香乌龙霜降</div>
                </div>
                <div className="box">
                    <img alt="" src={p10} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">四季春霜降</div>
                </div>
                <div className="box">
                    <img alt="" src={p11} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">玫瑰乌龙霜降</div>
                </div>
            ...
            <div className="images">
                <div className="box">
                    <img alt="" src={p12} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">油切乌龙霜降</div>
                </div>
                <div className="box">
                    <img alt="" src={p13} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">玄米煎茶霜降</div>
                </div>
                <div className="box">
                    <img alt="" src={p14} style={{ width: "100%", height: "100%" }} />
            ...
            <div className="images">
                <div className="box">
                    <img alt="" src={p06} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">油切乌龙霜降</div>
                </div>
                <div className="box">
                    <img alt="" src={p07} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">玄米煎茶霜降</div>
                </div>
                <div className="box">
                    <img alt="" src={p08} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">红玉茗茶霜降</div>
                </div>
            </div>
            ...
            <div className="images">
                <div className="box">
                    <img alt="" src={p15} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">油切乌龙霜降</div>
                </div>
                <div className="box">
                    <img alt="" src={p16} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">玄米煎茶霜降</div>
                </div>
                <div className="box">
                    <img alt="" src={p17} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">红玉茗茶霜降</div>
                </div>
            </div>
            ...
            <div className="images">
                <div className="box">
                    <img alt="" src={p18} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">油切乌龙霜降</div>
                </div>
                <div className="box">
                    <img alt="" src={p07} style={{ width: "100%", height: "100%" }} />
...
const PR = () => {
    return (
        <div className="sub-container">
            ...
            <div className="images">
                <div className="box">
                    <img alt="" src={r01} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">包1</div>
                </div>
                <div className="box">
                    <img alt="" src={r02} style={{ width: "100%", height: "100%" }} />
                    <div className="normal-text normal-color">包2</div>
                </div>
                <div className="box">
                    <img alt="" src={r03} style={{ width: "100%", height: "100%" }} />
