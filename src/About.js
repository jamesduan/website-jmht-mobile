...
const Intro = () => {
    return (
        <div className="sub-container">
            ...
            <p className="normal-text normal-color" style={{ textIndent: "2em" }}>
            ...
            <p className="normal-text normal-color" style={{ textIndent: "2em" }}>创全国名牌，建标杆企业。</p>
            <p className="title t">经营理念</p>
            <p className="normal-text normal-color" style={{ textIndent: "2em" }}>以匠心打造产品，用专业引领创新 用品质立足市场。</p>
            <p className="title t">企业宗旨</p>
            <p className="normal-text normal-color" style={{ textIndent: "2em" }}>用心服务 务实诚信 以德兴企 锐意进取。</p>
        </div>
    )
}
...
const BrandStory = () => {
    return (
        <div className="sub-container">
            ...
            <p className="normal-text normal-color " style={{ textIndent: "2em" }}>茶香喉，沁心田
                味芳醇，意缱绻
                九亩花田
                九亩方圆，阳光一片
                花田锦绣，芳华明媚
